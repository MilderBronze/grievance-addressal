...
const Login = () => {
  ...
  return (
    <div className="vh-100" style={{ backgroundColor: "orange" }}>
          ...
          <div className="signup-content">
            <div className="signup-form row">
              <div className="signup-image col-md-6">
                ...
                <NavLink to="/AdminLogin" className="login-image-link">
                  {" "}
                  &nbsp;LOGIN AS ADMIN
                </NavLink>
              </div>
                ...
                >
                  ...
                  <div className="form-group form-button">
                    <input
                      ...
                      name="signin"
                      id="signin"
                      className="form-submit login btn btn-outline-primary"
                      onClick={loginUser}
                      value="Log In"
                    />
                  </div>
      ...
      <div
        ...
        className="contact_info text-white mt-5"
      >
