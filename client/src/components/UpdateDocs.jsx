    ...
    <div className="mx-3">
      ...
      <div className="jumbotron">
        ...
        <div className="formdata">
          ...
          <div className="row">
            <h6>Phone:</h6>
            <p className="mx-2">{Data.phone}</p>
          </div>
          <div className="row">
            <h6>Grievance:</h6>
            <p className="mx-2">{Data.grievance}</p>
          </div>

          <form method="POST">
            <div className="row">
              <h6>Email:</h6>
              <p name="email" type="text" className="mx-2" value={email}>
                {email}
              </p>
            </div>
            <div className="row">
              <h6>Department:</h6>
              <p name="dept" type="text" className="mx-2" value={dept}>
                {dept}
              </p>
            </div>
            <div className="row">
